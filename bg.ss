  ...
  (fx-program!
   ...
   '((precision mediump float)
     ...
     (define (main) void
       ...
       (local float w (+ "0.020" (* (hash (+ sd (fl 5))) "0.018")))
       ...
       (local float sw (max (* w tip) "0.005"))
       ...
       (local float bw (max (* (* w (fl 0 85)) bt) "0.0045"))
       ...
       (local float bwp (max (* (* w (fl 0 85)) btp) "0.0045"))
       ...
       (local float sw2 (max (* (* w (fl 0 60)) st) "0.004"))
